...
import 'package:flutter_sports/widgets/direction_button.dart';

/// @author jd

class SportsArticleDetailPage extends StatefulWidget {
  const SportsArticleDetailPage({Key? key}) : super(key: key);

  @override
  State createState() => _SportsArticleDetailPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<String>(
        future: AssetBundleUtils.loadString('assets/data/content.md'),

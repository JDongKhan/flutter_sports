...
import '/widgets/mask/bubble_widget.dart';
import '/widgets/mask/mask_widget.dart';
...
class _DiscoverPageState extends State<DiscoverPage>
  ...
  void _pushSaved(String title, String router, dynamic page) async {
    ...
    if (page != null) {
      NavigationUtil.push(page);
      return;
    }

    // Navigator.pushNamed(context, router);
    var map = NavigationUtil.pushNamed(router, arguments: {'title': title});
    //带有返回值

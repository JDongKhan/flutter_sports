...
import 'package:flutter_sports/page/home/vm/sports_tab_home_vm.dart';
...
class TabHomePage extends StatefulWidget {
  ...
  static build() {
    final SportsTabHomeVM vm = Get.put(SportsTabHomeVM());
...
class _TabHomePageState extends State<TabHomePage>
  ...
  Widget build(BuildContext context) {
    SportsTabHomeVM vm = Get.find<SportsTabHomeVM>();
    return Scaffold(
        appBar: AppBar(
